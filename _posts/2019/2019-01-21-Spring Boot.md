...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <bean id="helloService" class="com.yuan.springboot.service.HelloService"></bean>
</beans>
```
...
<form>
    ...
    <div class="form-group">
        <label>Email</label>
        <input type="email" class="form-control" placeholder="zhangsan@yuan.com">
    </div>
    <div class="form-group">
...
-->
    ...
    <div class="form-group">
        <label>Email</label>
        <input name="email" type="email" class="form-control" placeholder="zhangsan@yuan.com" th:value="${emp!=null}?${emp.email}">
    </div>
    <div class="form-group">
        <label>Gender</label><br/>
        <div class="form-check form-check-inline">
...
​	2）、导入虚拟机文件centos7-yuan.ova；

​	3）、双击启动linux虚拟机;使用  root/ root123登陆
...
@MapperScan(value = "com.yuan.springboot.mapper")
@SpringBootApplication
...
com.yuan.springboot.listener.HelloApplicationContextInitializer

org.springframework.boot.SpringApplicationRunListener=\
com.yuan.springboot.listener.HelloSpringApplicationRunListener
```
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <groupId>com.yuan.starter</groupId>
    <artifactId>yuan-spring-boot-starter</artifactId>
    ...
    <dependencies>
        ...
        <dependency>
            <groupId>com.yuan.starter</groupId>
            <artifactId>yuan-spring-boot-starter-autoconfigurer</artifactId>
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
   ...
   <name>yuan-spring-boot-starter-autoconfigurer</name>
...
```java
package com.yuan.starter;

import org.springframework.boot.context.properties.ConfigurationProperties;

@ConfigurationProperties(prefix = "yuan.hello")
...
public class HelloService {
    ...
    public String sayHellyuan(String name){
